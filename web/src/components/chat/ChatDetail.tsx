...
import {
  ...
  formatMessageTime,
  inferFileMimeType,
  inferVisualMediaMimeType,
  isConversationEvent,
  isUserPetUpdatedEvent,
  isUserProfileUpdatedEvent,
  loadLocalChatSettings,
  mapCloudExchangeRequests,
  mergeExchangeRequests,
  readApiErrorMessage,
  readAudioDuration,
  readIceCandidate,
  readSessionDescription,
} from "./detail/chatDetailUtils";
...
function ChatMediaPreviewOverlay({
  ...
  return (
    <div className="fixed inset-0 z-[90] h-[100dvh] w-screen overflow-hidden bg-black text-white">
      <button
        type="button"
        onClick={onClose}
