...
postsRouter.post("/", async (req, res) => {
  ...
  const post: CommunityPost = {
    ...
    mediaUrls,
    mediaPosterUrl: optionalString(body.mediaPosterUrl) && body.mediaPosterUrl?.trim() ? body.mediaPosterUrl.trim() : undefined,
...
postsRouter.patch("/:postId", async (req, res) => {
  ...
  const updatedPost = await postgresStore.updatePost(post.id, {
    ...
    ...mediaPatch,
    ...(typeof body.mediaPosterUrl === "string" ? { mediaPosterUrl: body.mediaPosterUrl.trim() || undefined } : {}),
